...
simple_expr_:
  simple_expr PLUS simple_expr                       { EBinop (BAdd, $1, $3) }
| simple_expr MINUS simple_expr                      { EBinop (BSub, $1, $3) }
| simple_expr TIMES simple_expr                      { EBinop (BMul, $1, $3) }
| simple_expr DIV simple_expr                        { EBinop (BDiv, $1, $3) }
| simple_expr AND simple_expr                        { EBinop (BAnd, $1, $3) }
| simple_expr OR simple_expr                         { EBinop (BOr, $1, $3) }
| simple_expr EQUAL simple_expr                      { EBinop (BEq, $1, $3) }
| simple_expr LT simple_expr                         { EBinop (BLt, $1, $3) }
| simple_expr LE simple_expr                         { EBinop (BLe, $1, $3) }
| simple_expr GT simple_expr                         { EBinop (BGt, $1, $3) }
| simple_expr GE simple_expr                         { EBinop (BGe, $1, $3) }
| simple_expr NE simple_expr                         { EBinop (BNe, $1, $3) }
