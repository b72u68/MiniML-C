...
define i32 @inc0__body(i32 %x, %__list* %__env) {
inc0__body__entry:
...
main__entry:
  ...
  %inc0_clos$4 = bitcast i8* %temp46$3 to %__clos*
  %temp48$5 = bitcast %__list* %__env$2 to %__list*
  %temp49$6 = getelementptr %__clos, %__clos* %inc0_clos$4, i32 0, i32 0
  store %__list* %temp48$5, %__list** %temp49$6
  %temp47$7 = bitcast %__list* %temp48$5 to %__list*
  %temp53$8 = bitcast i32 (i32, %__list*)* @inc0__body to i32 (i32, %__list*)*
  %temp51$9 = bitcast i32 (i32, %__list*)* %temp53$8 to i32 ()*
  %temp52$10 = getelementptr %__clos, %__clos* %inc0_clos$4, i32 0, i32 1
  ...
  %temp61$17 = bitcast %__clos* %inc0_clos$4 to %__clos*
