...
main__entry:
  ...
  %temp19$3 = bitcast i32 1 to i32
  %temp20$4 = bitcast i32 2 to i32
  %temp17$5 = add i32 %temp19$3, %temp20$4
  %temp18$6 = bitcast i32 0 to i32
  %temp16$7 = icmp sgt i32 %temp17$5, %temp18$6
  br i1 %temp16$7, label %label5, label %label6
label5:
  %__ctemp0$14 = bitcast i32 1 to i32
  %temp14$15 = bitcast i32 %__ctemp0$14 to i32
  br label %label7
label6:
  %__ctemp0$12 = bitcast i32 0 to i32
  %temp15$13 = bitcast i32 %__ctemp0$12 to i32
  br label %label7
label7:
  %temp15$8 = phi i32 [0, %label5], [%temp15$13, %label6]
  %temp14$9 = phi i32 [%temp14$15, %label5], [0, %label6]
  %__ctemp0$10 = phi i32 [%__ctemp0$14, %label5], [%__ctemp0$12, %label6]
  %temp21$11 = bitcast i32 %__ctemp0$10 to i32
  ret i32 %temp21$11
}
